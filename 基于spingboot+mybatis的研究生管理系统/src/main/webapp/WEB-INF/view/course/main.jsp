		...
		<div class="modal-content">
			<form class="form-horizontal bv-form cmxform" method="post" onsubmit="return false">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="recipient-name" class="col-sm-2 col-lg-offset-1 control-label">课时:</label>
						<div class="col-sm-8"><input type="text" name="hour" id="hour" class="form-control" placeholder="课时" required></div>
...
<script type="text/javascript">
	...
	$("#course_add").click(function(){
		...
		if(hour == ""){
			$("#hour-error").html("请输入课时");
			a = 0;
		}else if(!(/^[1-9][0-9]*$/.test(hour) || hour > 0)){
			$("#hour-error").html("请输入数字");
			a = 0;
		}
